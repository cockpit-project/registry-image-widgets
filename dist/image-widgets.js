...
var v1="<div class=\"row\" ng-repeat=\"signature in signatures\">\n<dt translate><b>Signature</b></dt>\n<dd>{{ signature.metadata.name }}</dd>\n<dt translate>Verified</dt>\n<dd>\n<span class=\"pficon pficon-ok\" style=\"margin-right: 5px\" ng-if=\"signature.verified == 'Verified'\"></span>\n<span class=\"pficon pficon-error-circle-o\" style=\"margin-right: 5px\" ng-if=\"signature.verified == 'Failed verification'\"></span>\n<span class=\"pficon pficon-warning-triangle-o\" style=\"margin-right: 5px\" ng-if=\"signature.verified === 'Unverified'\"></span>\n<span translate=\"yes\">{{ signature.verified }}</span>\n</dd>\n<span ng-if=\"signature.verified == 'Verified'\">\n<dt translate>Details</dt>\n<dd>{{signatureDetails(signature)}}</dd>\n</span>\n</div>\n<div class=\"row\" ng-if=\"signatures.length == 0\">\n<span translate>No signatures</span>\n</div>\n";
